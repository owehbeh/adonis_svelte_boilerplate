...
<div class="my-2 px-2 w-1/3 overflow-hidden">
  <div class="form-control w-full max-w-xs">
    ...
    <input
      ...
      class="input input-bordered w-full max-w-xs"
      value={ note?.createdAt ? parseDbDateToInput(note.createdAt) : '' }
      required
    />
    <label class="label">
...
<div class="my-2 px-2 w-1/3 overflow-hidden">
  <div class="form-control w-full max-w-xs">
    ...
    <input
      ...
      class="input input-bordered w-full max-w-xs"
      value={ note?.updatedAt ? parseDbDateToInput(note.updatedAt) : '' }
      required
    />
    <label class="label">
...
<div class="my-2 px-2 w-1/3 overflow-hidden">
  <div class="form-control w-full max-w-xs">
    ...
    <select name="organization" class="select select-bordered w-full max-w-xs">
      ...
      <a href="/notes/{ note ? note.id : ''}" class="btn btn-ghost mt-8"> {txt('Back')} </a>
